...
<c:set value="${pageContext.request.contextPath}" var="cp"></c:set>
        ...
        <div class="modal-body">
          ...
          <input type="hidden" name="helpId" value="${helpInfo.helpId}">
         	<div class="form-group">
              <label for="lastname" class="col-sm-2 control-label">提问</label>
              <div class="col-sm-10">
                 <input placeholder=""  type="text" class="form-control" name="helpQuesition" value="${helpInfo.helpQuesition}" id="birthday">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <!-- 加载编辑器的容器 -->
    			<script id="container" name="helpAnswer" type="text/plain"  style="height:200px">${helpInfo.helpAnswer}</script>
              </div>
            </div>
...
function valiadate(){
	 $.ajax({
		 url:"${cp}/helpMananger/updateHelpInfo.htm",
