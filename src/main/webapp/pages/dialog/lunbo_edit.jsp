...
<c:set value="${pageContext.request.contextPath}" var="cp"></c:set>
		<div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">编辑轮播新闻信息</h4>
        </div>
        ...
        <div class="modal-body">
          ...
          <input type="hidden" name="tid" value="${newsInfo.tid}"> 
           ...
           <div class="form-group">
              ...
              <div class="col-sm-10">
                 ...
                 value="<fmt:formatDate value='${newsInfo.releasetime}'  pattern='yyyy-MM-dd HH:mm'/>">
              </div>
            </div>
            <%-- <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="file" class="form-control" style="width:240px" name="myfile"  accept="image/*" value="${newsInfo.imgUrl}" id="title">
...
<script>
 ...
 function valiadate(){
	 ...
	 $.ajax({
		 url:"${cp}/newsController/editLunboNews.htm",
